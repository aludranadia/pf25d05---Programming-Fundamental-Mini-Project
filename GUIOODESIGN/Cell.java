...
import java.awt.*;
/**
 * The GUIOODESIGN.Cell class models each individual cell of the game board.
 */
public class Cell {
    ...
    /** Content of this cell (GUIOODESIGN.Seed.EMPTY, GUIOODESIGN.Seed.CROSS, or GUIOODESIGN.Seed.NOUGHT) */
    Seed content;
    ...
    public void paint(Graphics g) {
        ...
        // Draw the GUIOODESIGN.Seed if it is not empty
